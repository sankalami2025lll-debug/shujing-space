...
- 当前不显示任何中文加载文案
- 加载专用 Logo 固定使用裁剪资源 `/brand/model-loading-logo-tight-v2.png`
- 2026-06-26 最终尺寸口径：Logo `w-[150px] sm:w-[170px] md:w-[200px] lg:w-[220px] xl:w-[240px]`；进度条 `w-[260px] sm:w-[300px] md:w-[360px] lg:w-[420px] xl:w-[460px]`
